	...
	class Water extends THREE.Mesh {
      ...
      `
				...
				void main() {
					...
					// Sakura Crossing: riflesso attenuato. Con rf0 = 0.3 (originale)
					// l'acqua e' uno specchio anche di fronte, e in una scena cel
					// shaded il cielo del tramonto la cancellava del tutto.
					float rf0 = 0.05;
					float reflectance = ( rf0 + ( 1.0 - rf0 ) * pow( ( 1.0 - theta ), 5.0 ) ) * 0.62;
					vec3 scatter = max( 0.0, dot( surfaceNormal, eyeDirection ) ) * waterColor;
					vec3 albedo = mix( ( sunColor * diffuseLight * 0.3 + scatter * 2.4 ) * getShadowMask(), ( vec3( 0.1 ) + reflectionSample * 0.9 + reflectionSample * specularLight ), reflectance);
